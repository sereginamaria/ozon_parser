...
def get_products_from_page_request(message, publication_category_page):
...
def get_product_request(message, publication_category_product):
...
def create_card_request(product_list):
