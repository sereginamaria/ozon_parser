...
def get_products_from_page(message, publication_category_page):
    ...
    requests.post("http://194.87.232.115:5000/get_products_from_page", json=data)
...
def get_product(message, publication_category_product):
    ...
    requests.post("http://194.87.232.115:5000/get_product", json=data)


def create_card(product_list):
    requests.post("http://194.87.232.115:5000/create_card", json=json.dumps(product_list))

def create_post(product_list):
    requests.post("http://194.87.232.115:5000/create_post", json=json.dumps(product_list))