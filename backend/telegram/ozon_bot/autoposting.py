...
def send_stylist_card():
    r = requests.post("http://" + BASE_URL + ":5001/ozon/send_stylist_card")
    print(r)
...
def autop():
    while True:
        ...
        if ((current_day_of_week == 'Tuesday' and in_time('10:00', current_time, '10:59')) or
        ...
        if ((current_day_of_week == 'Monday' and in_time('16:00', current_time, '16:59')) or
                (current_day_of_week == 'Thursday' and in_time('16:00', current_time, '16:59'))):
            send_post('Платье')
        ...
        if ((current_day_of_week == 'Thursday' and in_time('18:00', current_time, '18:59'))):
            send_post('Топ')

        if ((current_day_of_week == 'Wednesday' and in_time('6:00', current_time, '6:59'))):
            send_post('Футболка')
        ...
        if ((current_day_of_week == 'Friday' and in_time('18:00', current_time, '18:59'))):
            send_post('Рубашка')

        if ((current_day_of_week == 'Wednesday' and in_time('18:00', current_time, '18:59'))):
            send_post('Блузка')

        if ((current_day_of_week == 'Wednesday' and in_time('16:00', current_time, '16:59')) or
                (current_day_of_week == 'Saturday' and in_time('16:00', current_time, '16:59'))):
            send_post('Брюки')

        if ((current_day_of_week == 'Sunday' and in_time('10:00', current_time, '10:59'))):
            send_post('Юбка')

        if ((current_day_of_week == 'Sunday' and in_time('6:00', current_time, '6:59'))):
            send_post('Джинсы')

        if current_day_of_week == 'Friday' and in_time('6:00', current_time, '6:59'):
        ...
        if ((current_day_of_week == 'Thursday' and in_time('6:00', current_time, '6:59'))):
            send_post('Украшения')
