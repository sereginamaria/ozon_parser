...
#     import re
#
#     article = re.findall(r'/\d*/', url)
#     print(article)
#     # article = url.findall(/\d*/)?
#
#     # response = requests.get(url)
#     #
#     # print(response)
#
#     vendor_code = 155513303
#     headers = {'user-agent': UserAgent(browsers=['edge', 'chrome'])}
#     response = requests.get(url=f'https://card.wb.ru/cards/v2/detail?appType=1&curr=rub&dest=-1255987&spp=30&ab_testid=reranking_1&nm={vendor_code}')
#
