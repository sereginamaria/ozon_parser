...
function process(input_file_path, ouput_file_path) {
    // console.log('RUNNING')
    fs.readFile(input_file_path, function (err, body) {
        ...
        fs.writeFile(ouput_file_path, JSON.stringify(content), function () {
            console.log("Written");
        });
    });
}

module.exports.process = (input_file_path, output_file_path) => process(input_file_path, output_file_path)